...
?>
	    <form id="EditorForm" name="board_form" method="post" action="board_modify_news.php?num=<?=$num?>&page=<?=$page?>" enctype="multipart/form-data">
	    	 <ul id="board_form">
				<li>
	    	...
	    	<ul class="buttons">
				<li><button type="button" onclick="CKEDITOR.instances.content.updateElement(); check_input()">수정하기</button></li>
